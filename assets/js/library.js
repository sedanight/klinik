...
function my_validation(element, pesan) {
    $(element).next().remove();
    $(element).after('<div class="error" style="font-weight: normal;"><i style="color = red;">' + pesan + '</i></div>').closest('.form-group').removeClass('has-success').addClass('has-error');
}

function my_validation_remove(element) {
    $(element).next().remove();
